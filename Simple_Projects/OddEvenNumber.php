...
<body>
    <div>
        <form action="" class="bg-blue-400 flex flex-col justify-center py-5" method="GET">
            <input
                class="self-center focus:outline-dashed bg-gradient-to-r from-white to-gray-500 px-2 py-1.5 w-56 rounded-lg text-black text-lg"
                type="number" min="0" name="user_number" placeholder="Enter your number">
            <button class="self-center mt-3 py-1.5 px-3 rounded-full border-2 border-slate-700"
